...
function productSearch() {
    ...
    $app.append($search);
    $search.append("<form><input type='search' id='home-search' placeholder='search for your favourite makeup'><button id='submit'>Search</button></form>");
    $('#submit').on("click", function(evnt) {
        // console.log('#submit was clicked');
        evnt.preventDefault();
        var input = $('#home-search').val();
        appRouter.navigate('search/' + input, {
            trigger: true
        });
    });
}
